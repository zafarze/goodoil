...
# When deployed behind a TLS-terminating reverse proxy (e.g. Caddy), trust the
# X-Forwarded-Proto header so Django builds correct https:// URLs and CSRF works.
if _bool('BEHIND_PROXY', False):
